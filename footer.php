...
<div class="map--right">
    <iframe class="map--google"
        ...
        width="100%" height="500" style="border:0; margin:0;" allowfullscreen="" loading="lazy"
...
<div class="footer--container">
    ...
    <div class="footer--grid">
        <div class="footer--grid--box">
            ...
            <br>
            <p>Ul. Crvenog križa 35 <br>
                10 000 Zagreb <br></p>
            <a href="mailto:info@mckunaperic.hr"><span class="footer--mail">info@mckunaperic.hr</span></a> <br> <br>
            <a href="tel:+385 01 4555 400">+385 01 4555 400,</a><br>
            <a href="tel:+385 01 4551 333">+385 01 4551 333</a>

        </div>
        <div class="footer--grid--box">
            <p class="footer--text--bold">Radno vrijeme</p>
            <br>
            <p>Ponedjeljak,Petak</p>
            <p>09:00 - 15:00</p>
            <br>
            <p>Utorak,Srijeda,Četvrtak</p>
            <p>13:00-20:00</p>
        </div>
        <div class="footer--grid--box">
        ...
        <div class="footer--grid--box">
            ...
            <br>
            <a href="" class="index.php#aboutus">O nama</a><br>
            <a href="" class="">Novosti</a><br>
            <a href="" class="">Cjenik</a>
        </div>
    </div>
...
<div class="footer--container--desktop d-none">
    <div class="container--default">
        <div class="footer--info--desktop">
            ...
            <div class="footer--text--desktop">
                ...
                <a href="">Novosti</a><br>
                <a href="">Cjenik</a><br><br>
                <p><strong>Radno vrijeme</strong></p>
                <a>Ponedjeljak,Petak<br>08:00 - 15:00<br><br>Utorak,Srijeda,Četvrtak <br>13:00 - 20:00</a>
            </div>
            <div class="footer--text--desktop">
