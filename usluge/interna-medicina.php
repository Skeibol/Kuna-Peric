<base href="../" />
<?php
$title = "Interna medicina | Medicinski centar Kuna&Perić";
include "../header.php";
        ...
        <div class="img--hero--decor--services">
            <div class="hero--cta--services d-flex">
                <div class="hero--cta--text d-flex flex-column justify-content-start justify-content-sm-start">
                    <h1 class="hero--cta--slogan--services  mb-2">Interna medicina
                    </h1>
...
<div class="container--default">
    <div class="services--small--nav">
        ...
        <p>&nbsp;&nbsp; >&nbsp;&nbsp; </p>
        <a href="javascript:window.location.href=window.location.href">Interna medicina</a>
    </div>
    <div class="container-default">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="services--list mb-0">
                    ...
                    &#x2022; &nbsp;Kontrolni specijalistički
                    pregled<br>
                    &#x2022; &nbsp;Konzultacija<br>
                    &#x2022; &nbsp;Pregled u ambulanti za
                    osteoporozu<br><br>
    ...
    <p>Ako želite saznati više o našim uslugama interne medicine te osigurati najbolju skrb za svoje zdravlje
        i budućnost, <a class="local obratite--nam--se" href="#contact-us">slobodno nas kontaktirajte</a>. Naš tim je tu da odgovori na sva Vaša pitanja i dogovori termine
